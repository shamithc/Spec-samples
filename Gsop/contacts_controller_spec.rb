...
describe ContactsController do
  ...
  let(:valid_attributes) { { "contact_type" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contact" do
        ...
        Contact.any_instance.should_receive(:update).with({ "contact_type" => "MyString" })
        put :update, {:id => contact.to_param, :contact => { "contact_type" => "MyString" }}, valid_session
      end
